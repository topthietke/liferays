...
if (
 notificationsCount > 0 ) {
      ...
      out.write("'\n");
      out.write("\t\t\t\t\tclass=\"panel-notifications-count\"\n");
      out.write("\t\t\t\t\thref=\"");
 ...
 themeDisplay.isShowSignInIcon() ) {
      ...
      _jspx_th_clay_button_0.setAdditionalProps(
      ...
      _jspx_th_clay_button_0.setCssClass("sign-in text-default");
      _jspx_th_clay_button_0.setDisplayType("unstyled");
      _jspx_th_clay_button_0.setIcon("user");
      _jspx_th_clay_button_0.setLabel("sign-in");
      _jspx_th_clay_button_0.setPropsTransformer("{signInButtonPropsTransformer} from product-navigation-user-personal-bar-web");

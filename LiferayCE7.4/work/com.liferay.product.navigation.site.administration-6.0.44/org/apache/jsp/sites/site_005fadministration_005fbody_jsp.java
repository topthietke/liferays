...
if (
 siteAdministrationPanelCategoryDisplayContext.isDisplaySiteLink() ) {
          ...
          out.write("\t\t\t");
if (
 siteAdministrationPanelCategoryDisplayContext.isShowLayoutsTree() ) {
          out.write("\n");
          out.write("\t\t\t\t");
          //  clay:button
          ...
          _jspx_th_clay_button_0.setDynamicAttribute(null, "disabled",  siteAdministrationPanelCategoryDisplayContext.isLayoutsTreeDisabled() );
          ...
          _jspx_th_clay_button_0.setLabel("page-tree");
...
if (
 siteAdministrationPanelCategoryDisplayContext.isShowSiteAdministration() ) {
      ...
      out.write('\n');
if (
 (siteAdministrationPanelCategoryDisplayContext.getGroup() != null) && siteAdministrationPanelCategoryDisplayContext.isShowLayoutsTree() ) {
      out.write('\n');
      out.write('	');
      //  aui:script

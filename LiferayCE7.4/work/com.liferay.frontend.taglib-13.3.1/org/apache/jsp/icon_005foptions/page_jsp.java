...
public final class page_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/icon_options/init.jsp");
...
List<PortletConfigurationIcon> portletConfigurationIcons = (List<PortletConfigurationIcon>)request.getAttribute("liferay-frontend:icon-options:portletConfigurationIcons");
      ...
      _jspx_th_clay_dropdown$1menu_0.setDynamicAttribute(null, "aria-label",  LanguageUtil.get(request, "options") );
      _jspx_th_clay_dropdown$1menu_0.setBorderless( true );
      _jspx_th_clay_dropdown$1menu_0.setCssClass("component-action portlet-options");
      _jspx_th_clay_dropdown$1menu_0.setDisplayType("secondary");
      _jspx_th_clay_dropdown$1menu_0.setDropdownItems( (List<DropdownItem>)request.getAttribute("liferay-frontend:icon-options:dropdownItems") );
      _jspx_th_clay_dropdown$1menu_0.setIcon("ellipsis-v");
      _jspx_th_clay_dropdown$1menu_0.setMonospaced( (boolean)request.getAttribute("liferay-frontend:icon-options:monospaced") );
      _jspx_th_clay_dropdown$1menu_0.setPropsTransformer("{PortletOptionsDropdownPropsTransformer} from frontend-taglib");
      _jspx_th_clay_dropdown$1menu_0.setSmall( true );
      _jspx_th_clay_dropdown$1menu_0.setDynamicAttribute(null, "title",  LanguageUtil.get(request, "options") );
